  ...
  <div class="section_whole_contents_wrapper">
    ...
    <div class="section_profile_wrapper">
      ...
      <div class="section_profile_image">
        <img class="tweet_user_image tweet_user_image_home_follow_follower" src=./image/<?php echo sanitize($other_user_image) ?>>
      </div></a>
      <p class="user_name"><?php echo $other_user_name ?></p>
    ...
    <?php foreach($follower_user as $follower_user_list) { ?>
      ...
      <form action="follower.php" method="post" class="form_follow">
