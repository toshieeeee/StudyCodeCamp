...
function get_user_tweet_list($link) {
  ...
  $sql = 'SELECT tweet_table.user_id,tweet_table.tweet_id,tweet_table.user_tweet_reply_id,tweet_table.retweet_id,user_table.user_name,tweet_table.user_tweet_str,tweet_table.user_tweet_time FROM tweet_table JOIN user_table ON tweet_table.user_id = user_table.user_id'; // SQL生成
