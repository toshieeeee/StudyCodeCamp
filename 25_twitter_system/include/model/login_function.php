...
function get_user_name($link,$user_address,$user_passwd){ //$link = PDOオブジェクト

  global $error;

  $sql = 'SELECT user_name FROM user_table WHERE user_address = "' .$user_address. '" AND user_passwd = "'.$user_passwd .'"';
